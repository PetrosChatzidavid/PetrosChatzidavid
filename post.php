        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                if(isset($_POST['create_comment'])){
                    ...
                    $query = "INSERT INTO comments (comment_post_id, comment_post_author, comment_post_email, comment_content, comment_status, comment_date)";
                ...
                while ($row = mysqli_fetch_array($select_comment_query)){
                    ...
                    $comment_author  = $row['comment_post_author'];
                ?>
